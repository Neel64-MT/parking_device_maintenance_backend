...
async function seed() {
  ...
  await query('TRUNCATE push_subscriptions, notifications, ticket_event_parts, ticket_assignments, ticket_events, tickets, devices, user_roads, password_reset_tokens, users, role_permissions, roles, issue_subcategories, issue_categories, parts, roads, token_denylist, id_counters RESTART IDENTITY CASCADE')
